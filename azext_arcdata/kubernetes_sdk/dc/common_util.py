...
from azext_arcdata.kubernetes_sdk.dc import constants as dc_constants
...
def validate_infrastructure_value(infrastructure):
    ...
    msg = "infrastructure set to '{infrastructure}'. " "{INFRASTRUCTURE_CR_INVALID_VALUE_MSG}".format(
