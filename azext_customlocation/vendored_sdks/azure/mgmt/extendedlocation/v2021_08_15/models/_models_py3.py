...
class CustomLocation(TrackedResource):
    ...
    :ivar system_data: Metadata pertaining to creation and last modification
     of the resource
    :vartype system_data:
     ~azure.mgmt.extendedlocation.v2021_08_15.models.SystemData
    """
    ...
    def __init__(self, *, location: str, tags=None, identity=None, authentication=None, cluster_extension_ids=None, display_name: str=None, host_resource_id: str=None, host_type=None, namespace: str=None, provisioning_state: str=None, **kwargs) -> None:
...
class ErrorDetail(Model):
    ...
    :vartype details:
     list[~azure.mgmt.extendedlocation.v2021_08_15.models.ErrorDetail]
...
class Identity(Model):
    ...
    :param type: The identity type. Possible values include: 'SystemAssigned',
     'None'
    :type type: str or
     ~azure.mgmt.extendedlocation.v2021_08_15.models.ResourceIdentityType
    """
...
class PatchableCustomLocations(Model):
    ...
    def __init__(self, *, identity=None, authentication=None, cluster_extension_ids=None, display_name: str=None, host_resource_id: str=None, host_type=None, namespace: str=None, provisioning_state: str=None, tags=None, **kwargs) -> None:
